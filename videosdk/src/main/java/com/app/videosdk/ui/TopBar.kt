...
fun TopBar(
    ...
    val isReelsMode = mode == PlayerMode.REELS
    ...
    Row(
        ...
        if (!isReelsMode && isFullScreen && playerModel?.isClipEnabled == true) {
        ...
        if (!isReelsMode && isFullScreen && playerModel?.isChapterEnabled == true) {
        ...
        if (!isReelsMode && showFullScreenButton) {
            IconButton(
                ...
                CustomIcon(
                    resId = if (isFullScreen) {
                        playerModel?.customControls?.exitFullScreenIconRes
                    } else {
                        playerModel?.customControls?.fullScreenIconRes
                    },
                    defaultIcon = if (isFullScreen) {
